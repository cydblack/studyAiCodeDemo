...
model.save(os.path.join(_BASE_DIR, BOOK, "model", "word2Vec_1.model"))
...
# 保存模型
model2.save(os.path.join(_BASE_DIR, BOOK, "model", "word2Vec_2.model"))
print("-" * 400)
print(model2.wv.similarity("孙悟空", "猪八戒"))
print(model2.wv.similarity("孙悟空", "孙行者"))
print(model2.wv.similarity("金角", "铁扇公主"))
